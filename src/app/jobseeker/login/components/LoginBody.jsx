// import { handleJobSeekerLogin } from "@/actions/jobseeker";
    ...
    <div className="flex flex-col items-center justify-start  min-w-[350px] w-[70%] lg:w-[40%] my-11 gap-y-4">
      ...
      <div className="w-full flex flex-row justify-center items-center">
        ...
        >
          ...
          <button formAction={login} className="btn btn-block py-3 text-white rounded-full bg-[#4A42A3] hover:bg-[#5A53A9]">
            Login
          </button>
        </form>
